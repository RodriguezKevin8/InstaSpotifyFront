...
const MyMusic = () => {
	...
	return (
		<div className="flex flex-col items-center w-full h-full p-6 space-y-8 font-oswald">
			{/* Botón para crear nueva playlist */}
			<div className="w-full flex justify-center">
				<button
					onClick={() => navigate("/create-playlist")}
					className="bg-green-500 text-black text-xl px-6 py-2 rounded-lg hover:bg-green-600 transition"
				>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
				<Link to="/playlist" className="relative group">
					...
					<button className="absolute bottom-4 right-4 bg-black-500  p-2 rounded-full">
